  ...
  try {
    ...
    movimentacoes.forEach((mov) => {
      ...
      if (!dadosPorMaquina[maquinaId].ultimaMovimentacao || 
        ...
        dadosPorMaquina[maquinaId].valoresEntrada = {
          fichas: parseFloat(mov.valorEntradaFichas || 0),
          notas: parseFloat(mov.valorEntradaNotas || 0),
          cartao: parseFloat(mov.valorEntradaCartao || 0),
        };
      }
