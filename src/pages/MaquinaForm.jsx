  ...
  const carregarMaquina = async () => {
    try {
      ...
      setFormData({
        ...
        vendaDinheiro: response.data.vendaDinheiro || "",
        vendaCartao: response.data.vendaCartao || "",
        comissao: response.data.comissao || "",
        liquido: response.data.liquido || "",
        totalVendido: response.data.totalVendido || "",
